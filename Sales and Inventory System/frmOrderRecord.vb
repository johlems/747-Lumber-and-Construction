...
Public Class frmOrderRecord
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            ...
            con.Open()
            cmd = New OleDbCommand("SELECT (OrderInfo.OrderNo)as [Order No],(OrderDate)as [Order Date],(OrderStatus) as [Order Status],(CustomerNo) as [Distributor ID],(CustomerName) as [Distributor Name],(ProductCode) as [Product Code],(ProductName) as [Product Name],(Weight) as [Weight],(Price) as [Price],(Cartons) as [Cartons],Packets,(TotalPackets) as [Total Packets],(OrderedProduct.TotalAmount) as [Total Amount] from orderinfo,orderedproduct where orderinfo.orderno=orderedproduct.orderno and OrderDate between #" & dtpOrderDateFrom.Value & "# And #" & dtpOrderDateTo.Value & "# order by orderinfo.OrderNo,OrderDate", con)
    ...
    Private Sub Button11_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button11.Click
        Try
            ...
            con.Open()
            cmd = New OleDbCommand("SELECT (OrderInfo.OrderNo)as [Order No],(OrderDate)as [Order Date],(OrderStatus) as [Order Status],(CustomerNo) as [Distributor ID],(CustomerName) as [Distributor Name],(ProductCode) as [Product Code],(ProductName) as [Product Name],(Weight) as [Weight],(Price) as [Price],(Cartons) as [Cartons],Packets,(TotalPackets) as [Total Packets],(OrderedProduct.TotalAmount) as [Total Amount] from orderinfo,orderedproduct where orderinfo.orderno=orderedproduct.orderno and orderstatus = '" & cmbStatus.Text & "' order by orderinfo.OrderNo,OrderDate", con)
    ...
    Private Sub txtCustomer_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtCustomer.TextChanged
        Try
            ...
            con.Open()
            cmd = New OleDbCommand("SELECT (OrderInfo.OrderNo)as [Order No],(OrderDate)as [Order Date],(OrderStatus) as [Order Status],(CustomerNo) as [Distributor ID],(CustomerName) as [Distributor Name],(ProductCode) as [Product Code],(ProductName) as [Product Name],(Weight) as [Weight],(Price) as [Price],(Cartons) as [Cartons],Packets,(TotalPackets) as [Total Packets],(OrderedProduct.TotalAmount) as [Total Amount] from orderinfo,orderedproduct where orderinfo.orderno=orderedproduct.orderno and CustomerName like '" & txtCustomer.Text & "%' order by orderinfo.OrderNo,OrderDate", con)
    ...
    Private Sub TextBox1_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtProduct.TextChanged
        Try
            ...
            con.Open()
            cmd = New OleDbCommand("SELECT (OrderInfo.OrderNo)as [Order No],(OrderDate)as [Order Date],(OrderStatus) as [Order Status],(CustomerNo) as [Distributor ID],(CustomerName) as [Distributor Name],(ProductCode) as [Product Code],(ProductName) as [Product Name],(Weight) as [Weight],(Price) as [Price],(Cartons) as [Cartons],Packets,(TotalPackets) as [Total Packets],(OrderedProduct.TotalAmount) as [Total Amount] from orderinfo,orderedproduct where orderinfo.orderno=orderedproduct.orderno and ProductName like '" & txtProduct.Text & "%' order by orderinfo.OrderNo,OrderDate", con)
    ...
    Private Sub cmbProductName_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbProductName.SelectedIndexChanged
        Try
            ...
            con.Open()
            cmd = New OleDbCommand("SELECT (OrderInfo.OrderNo)as [Order No],(OrderDate)as [Order Date],(OrderStatus) as [Order Status],(CustomerNo) as [Distributor ID],(CustomerName) as [Distributor Name],(ProductCode) as [Product Code],(ProductName) as [Product Name],(Weight) as [Weight],(Price) as [Price],(Cartons) as [Cartons],Packets,(TotalPackets) as [Total Packets],(OrderedProduct.TotalAmount) as [Total Amount] from orderinfo,orderedproduct where orderinfo.orderno=orderedproduct.orderno and ProductName = '" & cmbProductName.Text & "' order by orderinfo.OrderNo,OrderDate", con)
    ...
    Private Sub cmbCustomerName_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbCustomerName.SelectedIndexChanged
        Try
            ...
            con.Open()
            cmd = New OleDbCommand("SELECT (OrderInfo.OrderNo)as [Order No],(OrderDate)as [Order Date],(OrderStatus) as [Order Status],(CustomerNo) as [Distributor ID],(CustomerName) as [Distributor Name],(ProductCode) as [Product Code],(ProductName) as [Product Name],(Weight) as [Weight],(Price) as [Price],(Cartons) as [Cartons],Packets,(TotalPackets) as [Total Packets],(OrderedProduct.TotalAmount) as [Total Amount]  from orderinfo,orderedproduct where orderinfo.orderno=orderedproduct.orderno and CustomerName = '" & cmbCustomerName.Text & "' order by orderinfo.OrderNo,OrderDate", con)
    ...
    Private Sub cmbOrderNo_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbOrderNo.SelectedIndexChanged
        Try
            ...
            con.Open()
            cmd = New OleDbCommand("SELECT (OrderInfo.OrderNo)as [Order No],(OrderDate)as [Order Date],(OrderStatus) as [Order Status],(CustomerNo) as [Distributor ID],(CustomerName) as [Distributor Name],(ProductCode) as [Product Code],(ProductName) as [Product Name],(Weight) as [Weight],(Price) as [Price],(Cartons) as [Cartons],Packets,(TotalPackets) as [Total Packets],(OrderedProduct.TotalAmount) as [Total Amount] from orderinfo,orderedproduct where orderinfo.orderno=orderedproduct.orderno and orderinfo.Orderno = '" & cmbOrderNo.Text & "' order by orderinfo.OrderNo,OrderDate", con)
