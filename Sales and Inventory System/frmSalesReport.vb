...
Public Class frmSalesReport
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        Try
            ...
            myConnection = New OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=|DataDirectory|\SI_DB.accdb;Persist Security Info=False;")
            MyCommand.Connection = myConnection
            MyCommand.CommandText = "select * from Billinfo where CustomerName= '" & cmbCustomerName.Text & "' and BillingDate between #" & DateTimePicker4.Text & "# And #" & DateTimePicker3.Text & "# order by BillingDate"
